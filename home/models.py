...
class Event(models.Model):
    ...
    description = RichTextField(help_text="Dieser Text wird in der Übersicht aller Events eventuell abgeschnitten (Die ersten 100 Wörter) präsentiert und nur auf der Detailansicht vollständig angezeigt. Die wichtigsten Fakten also am Anfang")
